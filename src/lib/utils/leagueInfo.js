/*   STEP 1   */
export const leagueID = "784281822820421632"; // your league ID
export const leagueName = "Shnantasy"; // your league name
...
export const homepageText = `
  <p>BIENVENIDOS A NUESTRA NUEVA WEBSITE!!!!</p>
  <p>AHUEVO CHINGADOS QUE NUNCA MUERA ESTO!!!!</p>
  <p>PRONTO LLEGARA UN NUEVO INTEGRANTE?</p>
  <p> NOTICIAS IMPORTANTES: <p>
  <p> GANADOR DEL AÑO --> ARMANDEX! <p>
`;
